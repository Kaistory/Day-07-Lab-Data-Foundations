...
Nhóm (Bàn E2) thống nhất 1 bộ tài liệu (8 chương Luật 116/2025) và 5 benchmark queries; mỗi thành viên thử **một chiến lược chunking khác nhau**, chạy cùng query để so sánh.

| Thành viên (MSV) | Strategy | Score (/10) | Điểm mạnh | Điểm yếu |
|------------------|----------|:-----------:|-----------|----------|
| Dương Quang Khải (2A202600708) — *Tôi* | **ArticleChunker (`dieu`)** | **9.0** | Trỏ đúng Điều, citation đẹp (điền `dieu`), giữ trọn điều luật | Điều rất dài vẫn phải cắt nhỏ |
| Vũ Xuân Bách (2A202600776) | ClauseChunker (`khoan`) | 8.5 | Score thô cao nhất (0.771), pinpoint đúng khoản | Chunk nhỏ, đôi khi mất ngữ cảnh điều |
| Nguyễn Thành Lộc (2A202600817) | ParagraphChunker (`paragraph`) | 8.0 | Giữ ngữ cảnh đoạn tốt, vẫn trỏ đúng Chương VI | Ranh giới đoạn không khớp 100% ranh giới Điều |
| Đặng Tiến Quyền (2A202600896) | FixedSizeChunker (`fixed`) | 6.5 | Đơn giản, số chunk dự đoán được, trỏ đúng chương | Cắt cứng giữa Điều/Khoản → mất ý |
| Nguyễn Hồng Phúc (2A202600843) | RecursiveChunker (`recursive`) | 6.0 | Score thô cao (0.747) |  gộp nhiều Điều vào 1 chunk (vỡ vụn) |

> Quy ước điểm /10: kết hợp **similarity thô** và **độ đúng** (trỏ đúng chương/điều). Strategy có score cao nhưng **sai chương** (recursive) bị trừ mạnh.

**Strategy nào tốt nhất cho domain này? Tại sao?**
> Với văn bản luật, **các chunker tôn trọng ranh giới ngữ nghĩa** (`dieu`, `khoan`, `paragraph`) cho retrieval chính xác hơn hẳn chunker cắt máy móc (`recursive`, `fixed`). Cả nhóm thống nhất **`dieu` (ArticleChunker)** tốt nhất tổng thể: tuy `khoan` có similarity thô cao hơn chút, `dieu` trỏ đúng **Điều** và điền được trường citation (Điều/Chương) — cực kỳ quan trọng cho ứng dụng tra cứu pháp luật cần trích dẫn nguồn. `recursive` là bài học phản diện: score cao nhưng gộp nhiều điều rời rạc → nhiễu.
...
| 4 | Lực lượng bảo vệ ANM | "Điều 30. Lực lượng bảo vệ an ninh mạng bao gồm: a) Lực lượng chuyên trách… tại Bộ Công an, Bộ Quốc phòng…" | **0.743** | ✓ | luat116_ch06.md |
